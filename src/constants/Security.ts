...
export const SECURITY_DESCRIPTION =
  'At SureBank, we prioritize the security and confidentiality of your financial information. Our state-of-the-art encryption technology and stringent data protection measures ensure your assets and transactions are safeguarded at all times';
...
export const SECURITY = [
  {
    ...
    icon_url: '/icons/security/icon-1.svg',
    className: 'lg:rounded-tl-[40px] lg:rounded-br-[40px]',
  },
  {
    _id: 2,
    ...
    icon_url: '/icons/security/icon-2.svg',
    className: 'lg:rounded-tr-[40px] lg:rounded-bl-[40px]',
  },
  {
    _id: 3,
    ...
    icon_url: '/icons/security/icon-3.svg',
    className: 'lg:rounded-bl-[40px] lg:rounded-tr-[40px]',
  },
  {
    _id: 4,
    ...
    icon_url: '/icons/security/icon-4.svg',
    className: 'lg:rounded-br-[40px] lg:rounded-tl-[40px]',
  },
];
